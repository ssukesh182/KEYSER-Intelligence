...
export default function AppReviews({ onEnter, onNavigate }) {
  return (
    <>
      {/*  SideNavBar  */}
<aside className="fixed left-0 top-0 h-screen flex flex-col p-6 border-r border-[#09152e]/5 bg-[#f2f3ff] dark:bg-[#09152e] w-72 z-40">
<div className="mb-10 px-4">
<h2 className="font-headline font-bold text-lg text-primary uppercase tracking-[0.2em]">Intelligence</h2>
<p className="text-[10px] text-on-surface-variant uppercase tracking-widest opacity-60">Sovereign Framework</p>
</div>
<nav className="flex-1 space-y-2">
<a className="flex items-center gap-3 px-4 py-3 text-[#1F2A44]/60 hover:bg-white/50 rounded-xl transition-all duration-300" href="#">
<span className="material-symbols-outlined">dashboard</span>
<span className="font-medium text-sm">Overview</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 text-[#1F2A44]/60 hover:bg-white/50 rounded-xl transition-all duration-300" href="#">
<span className="material-symbols-outlined">update</span>
<span className="font-medium text-sm">Website Changes</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 text-[#1F2A44]/60 hover:bg-white/50 rounded-xl transition-all duration-300" href="#">
<span className="material-symbols-outlined">ads_click</span>
<span className="font-medium text-sm">Google Ads</span>
</a>
{/*  Active Tab: App Reviews  */}
<a className="flex items-center gap-3 px-4 py-3 bg-white text-[#09152e] rounded-xl shadow-sm scale-105" href="#">
<span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>rate_review</span>
<span className="font-bold text-sm">App Reviews</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 text-[#1F2A44]/60 hover:bg-white/50 rounded-xl transition-all duration-300" href="#">
<span className="material-symbols-outlined">person_search</span>
<span className="font-medium text-sm">Hiring Tracker</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 text-[#1F2A44]/60 hover:bg-white/50 rounded-xl transition-all duration-300" href="#">
<span className="material-symbols-outlined">radar</span>
<span className="font-medium text-sm">Whitespace Radar</span>
</a>
</nav>
<div className="mt-auto space-y-2 pt-6 border-t border-primary/5">
<button className="w-full flex items-center justify-center gap-2 py-4 bg-primary text-white rounded-xl font-bold text-sm mb-4 hover:opacity-90 transition-opacity">
<span className="material-symbols-outlined text-sm">bolt</span>
                AI Co-Pilot
            </button>
<a className="flex items-center gap-3 px-4 py-3 text-[#1F2A44]/60 hover:bg-white/50 rounded-xl transition-all" href="#">
<span className="material-symbols-outlined">settings</span>
<span className="font-medium text-sm text-label">Settings</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 text-[#1F2A44]/60 hover:bg-white/50 rounded-xl transition-all" href="#">
<span className="material-symbols-outlined">help_outline</span>
<span className="font-medium text-sm text-label">Support</span>
</a>
</div>
</aside>
{/*  Main Content Canvas  */}
...
{/*  TopAppBar  */}
<header className="fixed top-0 right-0 left-72 z-50 flex justify-between items-center px-12 h-20 bg-white/80 backdrop-blur-xl border-b-0">
<div className="flex items-center gap-8">
<div className="text-xl font-black text-[#09152e] uppercase tracking-widest font-headline">KEYSER Intelligence</div>
<nav className="hidden md:flex items-center gap-6">
<a className="text-[#1F2A44]/70 hover:text-[#09152e] font-medium text-sm transition-colors" href="#">Zepto</a>
<a className="text-[#1F2A44]/70 hover:text-[#09152e] font-medium text-sm transition-colors" href="#">Swiggy</a>
<a className="text-[#1F2A44]/70 hover:text-[#09152e] font-medium text-sm transition-colors" href="#">Blinkit</a>
</nav>
</div>
<div className="flex items-center gap-4">
<div className="flex items-center gap-2 bg-surface-container-low px-4 py-2 rounded-full">
<span className="material-symbols-outlined text-sm text-primary">history</span>
<span className="text-xs font-bold text-primary uppercase tracking-wider">30d</span>
</div>
<button className="bg-primary text-white px-6 py-2 rounded-xl font-bold text-sm hover:opacity-90 transition-all active:scale-95">
                    Refresh Data
                </button>
...
{/*  Footer  */}
<footer className="w-full flex justify-between items-center px-12 py-8 mt-auto border-t border-[#09152e]/5 bg-white">
<div className="flex items-center gap-6">
<span className="font-headline font-bold text-[#C9A227] tracking-widest text-[10px] uppercase">KEYSER Intelligence</span>
<span className="text-slate-400 font-label text-[10px] uppercase tracking-[0.1em]">SNUC Hacks '26</span>
</div>
<div className="flex items-center gap-8">
<a className="text-slate-400 hover:text-[#C9A227] font-label text-[10px] uppercase tracking-[0.1em] transition-colors" href="#">Privacy Policy</a>
<a className="text-slate-400 hover:text-[#C9A227] font-label text-[10px] uppercase tracking-[0.1em] transition-colors" href="#">Terms of Intelligence</a>
<a className="text-slate-400 hover:text-[#C9A227] font-label text-[10px] uppercase tracking-[0.1em] transition-colors" href="#">Institutional Access</a>
</div>
</footer>
</main>
{/*  Floating AI Context FAB (Suppressed on Details Page, but visible here for Intelligence context)  */}
<div className="fixed bottom-10 right-10 z-50">
<button className="bg-primary text-white w-14 h-14 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform active:opacity-80">
