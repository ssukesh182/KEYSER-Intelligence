  ...
  return (
    <aside className="fixed left-0 top-0 h-screen flex flex-col p-6 w-72 bg-white z-40 border-r border-primary/5">
      ...
      <nav className="flex-1 space-y-1">
        ...
        <a 
          className={currentPage === 'website_changes' ? activeClass : inactiveClass} 
          href="#" 
        ...
        <a 
          className={currentPage === 'google_ads' ? activeClass : inactiveClass} 
          href="#" 
        ...
        <a 
          className={currentPage === 'app_reviews' ? activeClass : inactiveClass} 
          href="#" 
        ...
        <a 
          className={currentPage === 'hiring' ? activeClass : inactiveClass} 
          href="#" 
        ...
        <a 
          className={currentPage === 'whitespace' ? activeClass : inactiveClass} 
          href="#" 
